...
class SegmentationHandler:
    ...
    def find_text_segments(self, target_words: List[TextInfo]) -> List[PolygonInfo]:
        ...
        for r in self.seg_results:
            ...
            # Loop through all rooms and check if room names are inside
            for mask in masks:
                ...
                for i in target_words:
                    ...
                    if is_inside:
                        is_name_found = True
                        labels_in_room_counter +=1
                        labels_in_room.append(room_name)
                        break
        ...
        return labels_in_room_counter, total_rooms_detected, labels_in_room
