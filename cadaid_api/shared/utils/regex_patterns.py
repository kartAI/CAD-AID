...
room_pattern = r'\b(?:[Ss]ov(?:erom)?|[Gg]ang|[Bb]od|[Bb]ad(?:erom)?|[Kk]jøkken|[Tt]rapp(?:erom)?|[Ss]tue|[Kk]ontor|[Ee]ntre|[Gg]arasje|[Tt]rappegang|[Tt]errasse|[Kk]ott|[Ss]al|[Uu]tvendig|[Cc]arport| \
[Hh]all|[Ww]alk-in|[Vv]ask)\b(?:\s*(?:\d+(?:[.,]\d+)?)\s*m²)?'
